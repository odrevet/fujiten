  ...
  const String conjugationJson = '''
{
  ...
  // Create deconjugator
  final deconjugator = JapaneseDeconjugator(conjugationJson);

  final testWords = ['食べたかった', 'かわいく', '行った', 'きれいだった'];

  for (final word in testWords) {
    final results = deconjugator.deconjugateWord(word);

    print('Results for $word:');
    for (final result in results) {
      print('  Word: ${result.word}, Length: ${result.originalLength}, Conjugations: ${result.numConjugations}');
    }
    print('');
  }
